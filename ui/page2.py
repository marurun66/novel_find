    ...
    **[한계] ✋네이버 API의 문제**:  
    ...
    st.markdown(
        ...
        **description**에서 다른 부가적인 정보는 제외하고 **줄거리**만을 요약 하기위해,  
        ...
        6574권 중 300권을 랜덤으로 추출하여 수상, 작가 연혁, 서평 등 책 설명의 부가적인 정보는 제외하고, **줄거리**만을 요약하여 라벨링한 후 파인튜닝을 진행했습니다.  
        에포크는 5회 진행, 그 중 오버튜닝 가능성이 가장 적은 에포크 2 모델을 채택하여 줄거리 요약을 진행했습니다.  
        책 설명에 줄거리가 없는 책은 제외하여 총 5532권의 책 데이터를 준비했습니다.
    ...
    KoBART로 description에서 summary를 정제한 5532권의 책 데이터를 토대로,  
